 ...
 * @author Dell
 */
public class First3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("             ONLY UPTO RS.10,000 DAILY");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        try{
           ...
           if(i>0){
            ...
            String msg="Hello, "+name+" your account is debited with "+amt+" amount.";
            String sub="Cash Withdrawl.";
