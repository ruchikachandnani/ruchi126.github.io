...
import java.sql.*;
import javax.swing.*;
public class First5 extends javax.swing.JFrame {
 ...
 if(flag<4){
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        try{
            String sql1="update records set pin='"+Integer.parseInt(t1.getText())+"' where pin='"+pin+"'";
            PreparedStatement pst1=conn.prepareStatement(sql1);
            int i=pst1.executeUpdate();
           if(i>0){
              JOptionPane.showMessageDialog(null, "your pin number is changed");  
              String sql="select name,email from records where pin='"+pin+"'";
            PreparedStatement pst=conn.prepareStatement(sql);
            ResultSet rs=pst.executeQuery();
            String name=rs.getString("name");
            String mail=rs.getString("email");
            String msg="Hello, "+name+" your pin has been successfully changed.";
            String sub="Change in ATM Pin.";
