...
import java.sql.*;
import javax.swing.*;
public class First6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("   ENTER NEW MOBILE NO.");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        try{
            String sql1="update records set mobile='"+Integer.parseInt(t1.getText())+"' where pin='"+pin+"'";
            PreparedStatement pst1=conn.prepareStatement(sql1);
            int i=pst1.executeUpdate();
           if(i>0){
              JOptionPane.showMessageDialog(null, "your mobile number is changed");  
              String sql="select name,email from records where pin='"+pin+"'";
            PreparedStatement pst=conn.prepareStatement(sql);
            ResultSet rs=pst.executeQuery();
            String name=rs.getString("name");
            String mail=rs.getString("email");
            String msg="Hello, "+name+" your mobile number is changed.";
            String sub="Change in Mobile number.";
